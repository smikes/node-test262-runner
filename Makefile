...
cover: $(JSSOURCES)
	./node_modules/.bin/istanbul cover --root lib --print=both ./node_modules/mocha/bin/_mocha --
...
.PHONY: install jslint jstest no-dos-endings cover check-coverage clean
